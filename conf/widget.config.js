...
module.exports = {
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      name: 'Jasmine',
      artist: '蔡徐坤',
      url: 'https://music.163.com/song/media/outer/url?id=2733718147.mp3',
      cover:
        'https://p1.music.126.net/MWLetvss7WccGz_EOD4Gug==/109951171786908958.jpg?param=130y130'
    }
  ],
  ...
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '7255435548', // 对应歌单的 id
  MUSIC_PLAYER_METING_LRC_TYPE:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_LRC_TYPE || '0', // 已废弃！！！可选值： 3 | 1 | 0（0：禁用 lrc 歌词，1：lrc 格式的字符串，3：lrc 文件 url）
